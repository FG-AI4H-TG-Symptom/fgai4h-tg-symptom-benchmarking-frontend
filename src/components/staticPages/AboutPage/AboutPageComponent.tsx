      ...
      <Box marginBottom={2}>
        <Card>
          ...
          <CardContent>
            ...
            <Typography>
              As mentioned on the focus group website: “The ITU/WHO Focus Group
              on artificial intelligence for health (FG-AI4H) works in
              partnership with the World Health Organization (WHO) to establish
              a standardized assessment framework for the evaluation of AI-based
              methods for health, diagnosis, triage or treatment decisions.
              Participation in the FG-AI4H is free of charge and open to all.”
            </Typography>
          </CardContent>
        </Card>
      </Box>
      <Card>
        ...
        <CardContent>
          <Typography gutterBottom>
            ...
            group “Artificial Intelligence for Health”, which works in
