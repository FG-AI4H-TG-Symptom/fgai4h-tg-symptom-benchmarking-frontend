  ...
  return (
    <>
      <FormSection title="Meta data" name="metaData">
        <AutoTextField label="Case name" type="text" name="name" autoComplete="off" />
        <AutoTextField label="Case description" type="text" name="description" autoComplete="off" optional />
        <Grid container spacing={2}>
          <Grid item xs={12} sm={8}>
            <AutoTextField label={`Identifier of the case's creator`} type="text" name="caseCreator" optional />
          </Grid>
          <Grid item xs={12} sm={4}>
            <AutoTextField label="Spreadsheet ID" type="text" name="spreadsheetCaseId" autoComplete="off" optional />
          </Grid>
        </Grid>
      </FormSection>

      <FormSection title="Case data" name="caseData">
        <FormBlock name="profileInformation" color="#a6a6f7" title="Profile information">
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} md={3} lg={2}>
              <AutoSelect label="Biological sex" name="biologicalSex">
                {berlinModelSchema.definitions.biologicalSex.enum.map((biologicalSex) => (
        ...
        <FormBlock name="presentingComplaints[0]" color="#67c567" title="Presenting complaint">
      ...
      <FormSection title="Values to predict" name="valuesToPredict">
        <Box marginBottom={2}>
          <AutoSelect name="expectedTriageLevel" label="Expected triage level">
            {berlinModelSchema.definitions.expectedTriageLevel.enum.map((expectedTriageLevel) => (
        ...
        <FormBlock name="expectedCondition" color="#a6a6f7" title="Expected condition">
        ...
        <FormBlock name="correctCondition" color="#e491e8" title="Correct condition">
          <ConditionSelect possibleValues={possibleConditions} />
        </FormBlock>
      </FormSection>
    </>
